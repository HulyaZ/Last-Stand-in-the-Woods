...
public class Stove : MonoBehaviour, IInteractable
{
    ...
    void ChatacterSetTemperature(bool isHeatingUp)
    {
        if (isHeatingUp && stoveLoad > 0)
        {
            ...
            InvokeRepeating("CharacterHeatUp", 1f, 2f);
        }
    ...
    void CancelAllInvoke(bool canc)
    {
        CancelInvoke(/*"CharacterCoolDown"*/);
    }
    ...
    private void OnEnable()
    {
        ...
        Character.PlayerKilled += CancelAllInvoke;
    }
